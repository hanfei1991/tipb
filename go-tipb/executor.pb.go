...
type Executor struct {
	...
	Partition        *TablePartition `protobuf:"bytes,8,opt,name=partition" json:"partition,omitempty"`
...
func (m *Executor) GetPartition() *TablePartition {
	if m != nil {
		return m.Partition
	}
	return nil
...
type TablePartition struct {
	Tables           []*TableScan `protobuf:"bytes,1,rep,name=tables" json:"tables,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (*TablePartition) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{1} }

func (m *TablePartition) GetTables() []*TableScan {
	if m != nil {
		return m.Tables
	}
	return nil
...
func (*TableScan) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{2} }
...
func (*Join) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{3} }
...
func init() {
	...
	proto.RegisterType((*TablePartition)(nil), "tipb.TablePartition")
...
func (m *Executor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Partition != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.Partition.Size()))
...
func (m *TablePartition) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tables = append(m.Tables, &TableScan{})
...
var fileDescriptorExecutor = []byte{
	...
	,
}
